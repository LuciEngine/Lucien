...
impl State {
    pub async fn new(window: &Window) -> Result<Self> {
        ...
        bind_group_layouts.push(&scene.materials[scene.models[0].mesh.material].diffuse_texture.layout);
    ...
    pub fn input(&mut self, _event: &winit::event::WindowEvent) -> bool { false }
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SwapChainError> {
        ...
        render_pass.set_bind_group(1, &self.scene.materials[self.scene.models[0].mesh.material].diffuse_texture.group, &[]);
        render_pass.set_bind_group(2, &self.scene.materials[self.scene.models[0].mesh.material].bind_group, &[]);
